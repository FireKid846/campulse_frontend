    ...
    <div className="min-h-screen bg-gradient-to-br from-[#bfd8fd] to-[#bfd8fd] relative overflow-hidden">
      <style>{`
        ...
        .shimmer-button {
          ...
          box-shadow: 0 4px 16px rgba(0, 46, 33, 0.3);
        }
        ...
        .tab-button::after {
          ...
          right: 0;
          height: 3px;
          background: linear-gradient(to right, #002e21, #f9dc5c);
          transform: scaleX(0);
      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-xl z-50 border-b border-[rgba(191,216,253,0.4)] shadow-sm">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <h1 className="text-xl font-bold bg-gradient-to-r from-[#002e21] via-[#004d3a] to-[#f9dc5c] bg-clip-text text-transparent">
              Campulse
            </h1>
            <div className="flex gap-6 items-center">
              <button 
                onClick={() => setActiveTab('home')}
                className={`tab-button text-sm font-medium text-[rgba(0,46,33,0.7)] hover:text-[#002e21] transition-colors ${activeTab === 'home' ? 'active text-[#002e21]' : ''}`}
              >
                Home
              </button>
              <button 
                onClick={() => setActiveTab('features')}
                className={`tab-button text-sm font-medium text-[rgba(0,46,33,0.7)] hover:text-[#002e21] transition-colors ${activeTab === 'features' ? 'active text-[#002e21]' : ''}`}
              >
                Features
              </button>
              <button 
                onClick={() => setActiveTab('team')}
                className={`tab-button text-sm font-medium text-[rgba(0,46,33,0.7)] hover:text-[#002e21] transition-colors ${activeTab === 'team' ? 'active text-[#002e21]' : ''}`}
              >
                Meet the Team
              </button>
              <button 
                onClick={handleGetStarted}
                className="shimmer-button group relative inline-flex items-center gap-2 text-white font-semibold px-5 py-2 rounded-lg text-sm transition-all"
              >
      ...
      {activeTab === 'home' && (
        <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-20 pb-16">
          <div className={`text-center max-w-4xl transition-all duration-1300 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
            <h1 className="text-5xl md:text-6xl font-bold mb-10 text-[#002e21] leading-tight animate-on-load">
              Welcome to Campulse
            </h1>
            
            <div className="mb-12 animate-on-load animate-delay-1">
              <img 
                src="/images/logo.png" 
                alt="Campulse Logo" 
              ...
              />
              <div className="w-full max-w-2xl h-48 mx-auto bg-white/40 backdrop-blur-sm rounded-2xl items-center justify-center hidden border-2 border-dashed border-[rgba(191,216,253,0.4)]">
      ...
      {activeTab === 'features' && (
        <section className="relative min-h-screen py-24 px-6">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 text-[#002e21]">
              What We Offer
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div className="feature-card bg-gradient-to-br from-white to-[#fefefe] backdrop-blur-lg p-8 rounded-2xl shadow-lg border-2 border-[rgba(249,220,92,0.2)] relative overflow-hidden">
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#bfd8fd] via-[#f9dc5c] to-[#bfd8fd]"></div>
                <h3 className="text-2xl font-bold mb-4 text-[#002e21]">Academic Management</h3>
                <p className="text-base text-[rgba(0,46,33,0.65)] leading-relaxed">
              ...
              <div className="feature-card bg-gradient-to-br from-white to-[#fefefe] backdrop-blur-lg p-8 rounded-2xl shadow-lg border-2 border-[rgba(249,220,92,0.2)] relative overflow-hidden">
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#bfd8fd] via-[#f9dc5c] to-[#bfd8fd]"></div>
                <h3 className="text-2xl font-bold mb-4 text-[#002e21]">Find Opportunities</h3>
                <p className="text-base text-[rgba(0,46,33,0.65)] leading-relaxed">
              ...
              <div className="feature-card bg-gradient-to-br from-white to-[#fefefe] backdrop-blur-lg p-8 rounded-2xl shadow-lg border-2 border-[rgba(249,220,92,0.2)] relative overflow-hidden">
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#bfd8fd] via-[#f9dc5c] to-[#bfd8fd]"></div>
                <h3 className="text-2xl font-bold mb-4 text-[#002e21]">Campus Marketplace</h3>
                <p className="text-base text-[rgba(0,46,33,0.65)] leading-relaxed">
              ...
              <div className="feature-card bg-gradient-to-br from-white to-[#fefefe] backdrop-blur-lg p-8 rounded-2xl shadow-lg border-2 border-[rgba(249,220,92,0.2)] relative overflow-hidden">
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#bfd8fd] via-[#f9dc5c] to-[#bfd8fd]"></div>
                <h3 className="text-2xl font-bold mb-4 text-[#002e21]">Stay Connected</h3>
                <p className="text-base text-[rgba(0,46,33,0.65)] leading-relaxed">
      ...
      {activeTab === 'team' && (
        <section className="relative min-h-screen py-24 px-6">
          <div className="max-w-5xl mx-auto">
            {/* Creator */}
            <div className="mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-[#002e21]">
                Meet the man who started it all
              </h2>
              <div className="max-w-2xl mx-auto bg-gradient-to-br from-white to-[#fcfcfc] backdrop-blur-lg p-8 rounded-2xl shadow-lg border-2 border-[rgba(191,216,253,0.4)] relative overflow-hidden">
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#bfd8fd] via-[#f9dc5c] to-[#bfd8fd]"></div>
                <div className="flex flex-col items-center text-center">
                  <div className="w-32 h-32 rounded-full bg-gray-100 mb-6 overflow-hidden border-4 border-white shadow-lg">
                    <img 
                    ...
                    <div className="w-full h-full flex items-center justify-center hidden bg-gray-200">
                      <span className="text-gray-600 text-xs">creator.jpg</span>
                    </div>
                  </div>
                  <h3 className="text-2xl font-bold mb-4 text-[#002e21]">{teamMembers.creator.name}</h3>
                  <p className="text-base text-[rgba(0,46,33,0.65)] leading-relaxed">{teamMembers.creator.info}</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {teamMembers.developers.map((dev, index) => (
                  <div key={index} className="feature-card bg-gradient-to-br from-white to-[#fcfcfc] backdrop-blur-lg p-6 rounded-2xl shadow-lg border border-[rgba(191,216,253,0.4)] relative overflow-hidden">
                    <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#bfd8fd] to-[#f9dc5c]"></div>
                    <div className="flex flex-col items-center text-center">
                      ...
                      <h3 className="text-lg font-bold mb-2 text-[#002e21]">{dev.name}</h3>
                      <p className="text-sm text-[rgba(0,46,33,0.65)] mb-4 leading-relaxed">{dev.info}</p>
      ...
      {/* Footer */}
      <footer className="relative bg-[#002e21] text-white py-12 px-6 border-t border-[rgba(249,220,92,0.2)]">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col items-center gap-6">
            <div className="text-center mb-2">
              <h3 className="text-2xl font-bold mb-2 bg-gradient-to-r from-[#bfd8fd] to-[#f9dc5c] bg-clip-text text-transparent">Campulse</h3>
              <p className="text-gray-400 text-sm">Built by Unilorin Students</p>
            </div>
            
            <div>
              <h4 className="text-base font-semibold mb-3 text-center">Connect With Us</h4>
